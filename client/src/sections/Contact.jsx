            ...
            >
              ...
              >
                <div className="h-64 bg-gray-200 dark:bg-gray-800 rounded-lg overflow-hidden">
                  <iframe 
                    src={`https://www.google.com/maps/embed/v1/place?q=${encodeURIComponent(contact.address)}&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8`}
                    style={{ border: 0 }}
                    allowFullScreen=""
                    loading="lazy"
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-[hsl(var(--gradient-start))] to-[hsl(var(--gradient-end))] text-white rounded-lg font-medium transition-all shadow-md hover:shadow-lg disabled:opacity-70"
                >
