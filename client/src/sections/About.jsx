...
const About = () => {
  const { personal_info, interests } = myData;
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <div className="space-y-6">
              ...
              >
                {[
                  { icon: <FaEnvelope className="text-[hsl(var(--accent))]" />, content: myData.contact.email, index: 0 },
                  { icon: <FaPhone className="text-[hsl(var(--accent))]" />, content: myData.contact.phone, index: 1 },
